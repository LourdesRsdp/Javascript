...
function sueldoNetoAnual(empleado) {
    ...
    document.getElementById("retenc").value = ret;
    console.log(result2);
...
function calcular() {
    ...
    var anual;
    const empleado = {
        bruto: parseFloat(document.getElementById("SalarioBruto").value),
        hijos: parseInt(document.getElementById("hijos").value),
        pagas: parseInt(document.getElementById("numpagas").value)
    };
    anual = sueldoNetoAnual(empleado);
    mensual = sueldoNetoMensual(empleado);
    document.getElementById("salNetoAn").value = anual;
    document.getElementById("salNetMens").value = mensual;
}
